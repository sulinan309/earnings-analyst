...
deep_analysis = DeepAnalysis(
    executive_summary=ExecutiveSummary(
        headline='腾讯是中国互联网最接近"永续复利机器"的标的——但487 HKD处于观察区，等430-460再布局',
        action="观察/等回落 — 当前487 HKD高于Base(386)约26%，低于Optimistic(569)约14%，处于观察区",
        tldr=[
            "v4.3估值：保守251 / 基准386 / 乐观569 HKD。当前487处于观察区，非明确加仓区",
            "OE锚定FCF 1826亿，基准OE取2000亿(g=3%, r=11%)，Guard Rail约束下估值较v4.2大幅下修(-44%)",
            "毛利率56%创历史新高+国际游戏首破100亿美元(+33%)+注销式回购EPS+18%——基本面无可挑剔",
            "等430-460进入可布局区再从30股加到150-200股。投资组合按极保守口径(上市50%+非上市20%)仅计入51 HKD/股",
        ],
        body=(
            ...
            "v4.3估值修正：Guard Rail要求OE≤1.2×FCF=2191亿，Non-IFRS净利2596亿远超此限。"
            "基准OE取2000亿(成熟业务1800+AI/视频号效率增量200)，g=3%(基准锚定)，r=11%。"
            "基准内在价值386 HKD vs 当前487——高出26%。乐观场景(g=5%, OE=2200亿)给出569 HKD。\n\n"
            "结论：当前价格处于观察区(386-569区间)。基本面是Watchlist中最优质的，但估值不够便宜。"
            "维持30股probe buy，等450-470分批加到100-150股更审慎。430以下接近Base值，明确加仓。"
        ),
    ),
