...
deep_analysis = DeepAnalysis(
    executive_summary=ExecutiveSummary(
        headline='快手年赚206亿但市场只给10倍PE——市场定价的是"不增长的赚钱机器"，我们认为可灵AI和效率优化正在被低估',
        action="买入（分批建仓） — 当前~45 HKD低于Action Price(~54 HKD)约17%，处于Buy zone",
        tldr=[
            "OE ~226亿(5.72 HKD/股)，内在价值~72 HKD vs 当前~45 HKD，折价~38%，IRR ~21% ✅超15%铁律",
            "AI赋能已在P&L兑现：广告收入+5%增量、AIGC素材消耗40亿、费用率-2.8pct结构性下降",
            "可灵AI从零到ARR 2.4亿美元，Sora已停服——全球视频生成赛道领先者之一",
            "核心风险：DAU 4.1亿已近天花板，如果开始净流失则所有变现逻辑崩塌",
        ],
        body=(
            "2025年报稳健——全年营收1428亿(+12.5%)，经调整净利润206亿(+16.5%)，毛利率55.0%，OCF 267亿。"
            "市场给出的反应是股价从52周高点92.6 HKD腰斩至~45 HKD，Trailing PE仅~10x。"
            "这意味着市场将快手定价为一家'不增长的赚钱机器'。\n\n"
            "我们的Variant View：市场过度锚定于用户增速放缓(DAU +2.7%)和电商GMV增速下滑(+15%→+12.9%)，"
            "但低估了三个正在发生的结构性变化：(1) AI对广告/电商效率的持续提升正在转化为真实的收入增量；"
            "(2) 可灵AI从零到ARR 2.4亿美元的商业化速度超预期；(3) 费用率的结构性下降(销售费用率从32.4%降至29.6%)"
            "意味着即使收入增速温和，利润增速可以持续跑赢。\n\n"
            "K0估值：OE 226亿 × (1+5%) / (12%-5%) + 净现金 = 内在价值~72 HKD/股。"
            "扣除25%安全边际后Action Price ~54 HKD。当前45 HKD低于Action Price 17%——处于买入区间。"
            "Base case 2年IRR ~21%，超过15%铁律门槛。"
        ),
    ),
