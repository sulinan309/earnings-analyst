...
deep_analysis = DeepAnalysis(
    executive_summary=ExecutiveSummary(
        ...
        tldr=[
            "估值：Conservative 16 / Base 22 / Optimistic 27 HKD。当前32高于乐观值19%——回避区",
            "Layer A(手机+IoT+互联网) OE~200亿是基本盘。Layer B(汽车+AI) OE仅~40亿",
            "Payback 29.9年(base)——三家中最贵。按价值框架不应持有或加仓",
            "当前32 HKD高于乐观值19%。OE框架下处于回避区，成长股定价逻辑与价值框架不冲突",
        ],
        body=(
            ...
            "估值约束：Guard Rail要求OE≤1.2×FCF。FCF估计~200亿(远低于经调整净利润392亿)——"
            ...
            "OE框架下32 HKD处于回避区(>Optimistic 27)。Payback 29.9年是五家中最长。"
            "成长股定价买入与价值框架结论不同——需明确自己使用的定价逻辑。"
        ),
    ),
